...
// Mod: MaHarder Assets
// File: editor.php
// Path: /engine/inc/maharder/assets/include/inc/static/editor.php
// =======================================================
...
function insertEditor($field, $iso) {
	global $config, $image_q_upload, $p_name, $dle_login_hash, $implugin, $image_upload,
	       $i18n_lang, $lang, $row, $ed_root, $user_group, $member_id;
	...
	if (empty($p_name) || !isset($p_name)) $p_name = $member_id['name'];
