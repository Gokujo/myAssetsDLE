...
foreach ($i18n_lang['active'] as $code => $lang_ar) {
	...
	$rubTitle .= <<<HTML
<br><br>{$lang['rubric_title']} ({$langD})<br><input type='text' name='title_{$lang_ar['iso2']}' id='dle-promt-title-{$lang_ar['iso2']}' class='classic' style='width:100%;' value=''>
HTML;

	$rubDescr .= <<<HTML
<br><br>{$lang['rubric_description']} ({$langD})<br><textarea name='description_{$lang_ar['iso2']}' id='dle-promt-descr-{$lang_ar['iso2']}' class='classic' style='width:100%;' rows='3'></textarea>
HTML;
